...
RUN mkdir -p /root/.jupyter && mkdir -p /pwrai/.jupyter && cp jupyter_notebook_config.json /root/.jupyter/ && cp jupyter_notebook_config.py /root/.jupyter/ && cp jupyter_notebook_config.json /root/.jupyter/ && cp jupyter_notebook_config.py /root/.jupyter/
